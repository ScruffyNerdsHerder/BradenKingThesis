...
resData_2_1 = zeros(length(Omega_sweep),N_max+1)
finalTheta_2_1 = zeros(length(Omega_sweep),N_max,5)
resData_2_2 = zeros(length(Omega_sweep),N_max+1)
finalTheta_2_2 = zeros(length(Omega_sweep),N_max,5)
resData_2_3 = zeros(length(Omega_sweep),N_max+1)
finalTheta_2_3 = zeros(length(Omega_sweep),N_max,5)
resData_2_4 = zeros(length(Omega_sweep),N_max+1)
finalTheta_2_4 = zeros(length(Omega_sweep),N_max,5)
resData_2_5 = zeros(length(Omega_sweep),N_max+1)
finalTheta_2_5 = zeros(length(Omega_sweep),N_max,5)
resData_2_6 = zeros(length(Omega_sweep),N_max+1)
finalTheta_2_6 = zeros(length(Omega_sweep),N_max,5)

@threads for i in eachindex(Omega_sweep)
    omega_init = Omega_sweep[i]
    solver_OmegaSweep(theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction}) = lsq_TV_solver_OmegaConstSweep(omega_init, theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction})
...
X_2D = X_Sine
@save "2D_BenchmarkConstCoarseSweep.jld2" X_2D Omega_sweep resData_2_1 finalTheta_2_1 resData_2_2 finalTheta_2_2 resData_2_3 finalTheta_2_3 resData_2_4 finalTheta_2_4 resData_2_5 finalTheta_2_5 resData_2_6 finalTheta_2_6
end