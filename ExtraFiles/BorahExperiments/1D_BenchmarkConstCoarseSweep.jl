...
@threads for i in eachindex(Omega_sweep)
    # Run the omega sweep on the AsymmetricRBF benchmark
        Omega = Omega_sweep[i]
        solver_OmegaSweep(theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction}) = lsq_TV_solver_OmegaConstSweep(Omega, theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction})
...
@save "1D_BenchmarkConstCoarseSweep.jld2" X_1D Omega_sweep resData_1 finalTheta_1 resData_2 finalTheta_2 resData_3 finalTheta_3 resData_4 finalTheta_4 resData_5 finalTheta_5
