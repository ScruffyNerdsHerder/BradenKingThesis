...
resData_2 = zeros(length(N0_Range)*length(C_Range),N_max+1)
finalTheta_2 = zeros(length(N0_Range)*length(C_Range),N_max,4)
resData_3 = zeros(length(N0_Range)*length(C_Range),N_max+1)
finalTheta_3 = zeros(length(N0_Range)*length(C_Range),N_max,4)
resData_4 = zeros(length(N0_Range)*length(C_Range),N_max+1)
finalTheta_4 = zeros(length(N0_Range)*length(C_Range),N_max,4)
resData_5 = zeros(length(N0_Range)*length(C_Range),N_max+1)
finalTheta_5 = zeros(length(N0_Range)*length(C_Range),N_max,4)
