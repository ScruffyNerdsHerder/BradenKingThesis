...
@threads for i in eachindex(N0_Sweep)
    C = N0_Sweep[i]
    solver_OmegaSweep(theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction}) = lsq_TV_solver_OmegaN0SweepExpDecrease(C, theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction})
...
@save "N0_OmegaSweep_1D.jld2" X_1D N0_Sweep resData_1 finalTheta_1 resData_2 finalTheta_2 resData_3 finalTheta_3 resData_4 finalTheta_4 resData_5 finalTheta_5
