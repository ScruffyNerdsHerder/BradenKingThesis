...
dx = 0.01
noiseLevel = 0.05
X, y_clean, A, D = benchmark_2D_data("ExtraFiles/data/normal_1000_doublecone_15deg.jld2", "Sine", 0.0)
...
plot!(fig, N_all, getindex.(res_history_LBFGS, 2), label="LBFGS", linewidth=lw, subplot=2)
...
plot!(fig, N_all, getindex.(res_history_LBFGS, 3), label="LBFGS", linewidth=lw, subplot=3)
