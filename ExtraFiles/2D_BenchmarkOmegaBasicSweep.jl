...
@threads for i in eachindex(Omega_sweep)
    ...
    solver_OmegaSweep(theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction}) = lsq_TV_solver_LBFGS(omega_init, theta0, X, res, A, D, N, T_phi::Type{<:BasisFunction})
...
@save "OmegaBasicSweep_2D.jld2" X_2D Omega_sweep resData_2_1 finalTheta_2_1 resData_2_2 finalTheta_2_2 resData_2_3 finalTheta_2_3 resData_2_4 finalTheta_2_4 resData_2_5 finalTheta_2_5 resData_2_6 finalTheta_2_6